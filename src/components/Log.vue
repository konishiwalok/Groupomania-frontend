        ...
        <div class="card col-8 col-lg-4 mx-auto bg-white py-4 borderopa">
            ...
            <form id="form" class="mt-5" @submit.prevent="login()" method="post" novalidate="true">
                <div class="form-group form-group-sm" :class="{ 'form-group--error': $v.email.$error }">
                    ...
                    <button class="btn  bg-info btn-sm mt-3" :disabled="isActive" type="submit" @click.prevent="login">Connexion</button>
            </form>
            <b-alert v-if="errorAlert" show dismissible variant="danger" class="col-10 mx-auto mt-5">Identifiant ou mot de passe incorrect ,Veuillez réessayer </b-alert>
             <hr class="line w-80">
            <div class="mt-1 pt-1">
                <button class="btn  bg-info btn-sm" @click.prevent="goSignin" >Inscription</button>
